...
def test_fully_backfilled_database_is_ready_and_json_safe(tmp_path):
    ...
    assert report["database"] == {
        # Pinned to the head migration (21 added the outcome-snapshot tables in
        # Phase 5.2), so a schema bump is a deliberate edit here rather than
        # something the audit silently starts reporting.
        "integrity_check": "ok", "foreign_key_violation_count": 0, "schema_version": 21,
    }
